...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string CurrentFilter, string searchString, int? pageNumber)
        {
            ...
            {
                students = students.Where(_ => _.LastName.Contains(searchString) || _.FirstName.Contains(searchString));
            }

            switch (sortOrder)
            {
                case "name_desc": students = students.OrderByDescending(_ => _.LastName); break;
                case "date": students = students.OrderBy(_ => _.EnrollmentDate); break;
                case "date_desc": students = students.OrderByDescending(_ => _.EnrollmentDate); break;
